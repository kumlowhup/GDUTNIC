...
# 先找到必应每日一图对应的js文件的网址
sourceWebsite = request.urlopen("https://www.bing.com/HPImageArchive.aspx?format=js&idx=0&n=1")
...
print(photoname)
os.rename('wallpaper.jpg',datetoday.strftime('20%y%m%d') + photoname + '.jpg')